/* Copyright (C) 2021 NAVEEN VIJAYAN
CODDED NAVEEN VIJAYAN
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'owner', fromMe: true, desc: 'shows the detail of bot owner'}, (async (message, match) => {
        ...
        if (Config.PLK == 'default') {
            await message.client.sendMessage(message.jid,'KallanserV2 created by *Naveen Vijayan*' , MessageType.text);
        }
        else {
